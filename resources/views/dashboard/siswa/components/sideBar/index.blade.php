        ...
        <ul class="mt-4">
            ...
            <li class="mb-1 group">
                <a href="#"
                    ...
                    <span class="text-sm">History Pembayaran</span>
                    <i class="ri-arrow-right-s-line ml-auto group-[.selected]:rotate-90"></i>
                </a>
                <ul class="pl-7 mt-2 hidden group-[.selected]:block">
                    <li class="mb-4">
                        <a href="/admin/dashboard/pembayaran/siswa"
                            class="text-gray-300 text-sm flex items-center hover:text-gray-100 before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3">Pembayaran</a>
                    </li>
                </ul>
                <ul class="pl-7 mt-2 hidden group-[.selected]:block">
                    <li class="mb-4">
                        <a href="/admin/dashboard/pembayaran/siswa/history"
