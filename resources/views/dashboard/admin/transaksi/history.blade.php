...
@section('container')
    <a href="/generate/laporan"
        class="cursor-pointer text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2">Generate
        Laporan</a>
                    ...
                    <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                        ...
                        <td class="px-6 py-4 flex flex-row justify-between items-center gap-x-8">
                            ...
                            <form action="/admin/dashboard/pembayaran/siswa/{{ $pembayaran->id_pembayaran }}"
                                ...
                                @csrf
                                <button type="submit"
                                    class="font-medium text-slate-400 dark:text-blue-500 hover:underline  p-4 bg-slate-200 shadow-lg rounded-lg">
                                    delete</button>
                            </form>
                        </td>
                    </tr>
