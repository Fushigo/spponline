...
@section('container')
    <form action="{{ route('pembayaran.store') }}" method="POST">
        ...
        <div class="mb-6">
            ...
            <input type="hidden" name="id_spp" id="nominal" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
            <input type="text" disabled name="id_spp_display" id="nominal_display" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
