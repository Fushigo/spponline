        ...
        <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8 items-center">
            <div class="w-1/2 h-fit bg-white p-8 py-16 rounded-lg shadow-xl">
                ...
                <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                    <form class="space-y-6" action="/siswa/login" method="POST">
                        @csrf
                        <div>
                            <label for="nisn" class="block text-sm font-medium leading-6 text-gray-900">NISN</label>
                            <div class="mt-2">
                                <input id="nisn" name="nisn" type="text" autocomplete="nisn"
                        ...
                        <div>
                            <div class="flex items-center justify-between">
                                <label for="nis" class="block text-sm font-medium leading-6 text-gray-900">Password
                                    <dd class="text-[11px]">Gunakan nis sebagai password</dd>
                                </label>
                            </div>
                            <div class="mt-2 relative">
                                <input id="nis" name="nis" type="password" autocomplete="current-nis"
                                    class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                                    value="{{ old('nis') }}">
